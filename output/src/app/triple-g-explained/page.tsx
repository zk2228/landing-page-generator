...
export default function TripleGExplainedPage() {
  return (
    <>
      <head>
        <title>Triple G Explained — Free Guide | RevitalizeMe</title>
        <meta
          name="description"
          content="How retatrutide targets 3 hormones where Ozempic targets 1. Free evidence-based guide from RevitalizeMe."
        />
        <meta
          property="og:title"
          content="Triple G Explained — Free Guide | RevitalizeMe"
        />
        <meta
          property="og:description"
          content="How retatrutide's 3-receptor approach is rewriting the playbook on metabolic weight loss. Free guide. Evidence-based. Provider-reviewed."
        />
      ...
      <div className="min-h-screen bg-white flex flex-col items-center px-4 py-10 sm:py-16">
        <div className="w-full max-w-2xl flex flex-col items-center">
          ...
          <h1 className="font-display text-[28px] sm:text-[34px] text-[#294547] text-center leading-tight mb-4">
            Triple G Explained: How the Next Generation of Weight Loss Medicine
            Actually Works
          </h1>

          {/* Subheadline */}
          <p className="text-center text-[#666666] text-base sm:text-lg leading-relaxed mb-8 max-w-xl">
            The free guide that breaks down why retatrutide&apos;s
            triple-receptor approach is producing 28.7% weight loss in clinical
            trials — and what it means for your options.
          </p>
          ...
          <div className="text-center mb-8">
            ...
            <span className="text-sm text-[#666666] mt-1 block">
              average body weight loss in Phase 3 trials
            </span>
          </div>
          ...
          >
            ...
            <input
              type="hidden"
              name="redirect"
              value="https://landing-page-generator-gamma.vercel.app/triple-g-explained/thank-you"
            />
            <input
              type="hidden"
              name="subject"
              value="New Lead: Triple G Explained Guide"
            />
            <input
              type="hidden"
              name="from_name"
          ...
          <div className="w-full bg-[#F0F9FA] rounded-xl p-6 sm:p-8 mb-12">
            ...
            <ul className="space-y-3 text-[#1A1A2E] text-sm sm:text-base mb-4">
              <li className="flex items-start gap-2">
                ...
                <span>
                  How 3 receptors produce dramatically better results than 1
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#81D9DE] mt-0.5 shrink-0">&#10003;</span>
                <span>The clinical trial numbers side by side</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#81D9DE] mt-0.5 shrink-0">&#10003;</span>
                <span>Why glucagon activation is the game-changer</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#81D9DE] mt-0.5 shrink-0">&#10003;</span>
                <span>
                  What&rsquo;s available now vs. what&rsquo;s coming
                </span>
              </li>
            </ul>
