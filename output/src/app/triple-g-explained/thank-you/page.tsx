...
export default function TripleGThankYouPage() {
  return (
    <>
      <head>
        ...
        <meta
          name="description"
          content="Download Triple G Explained — how retatrutide's triple-receptor approach is producing 28.7% weight loss in clinical trials. Evidence-based. Provider-reviewed."
        />
        <meta
          property="og:title"
        ...
        <meta
          ...
          content="Download your free copy of Triple G Explained. Evidence-based. Provider-reviewed."
        />
      ...
      <div className="min-h-screen bg-white flex flex-col items-center px-4 py-10 sm:py-16">
        <div className="w-full max-w-2xl flex flex-col items-center">
          ...
          <p className="text-center text-[#666666] text-base sm:text-lg leading-relaxed mb-8 max-w-xl">
            Click below to download your free copy of Triple G Explained.
          </p>

          {/* Download Button */}
          <a
            href="/triple-g-explained.pdf"
            download
          ...
          >
            Download Triple G Explained (PDF) &rarr;
          </a>
          ...
          <div className="w-full bg-[#F0F9FA] rounded-xl p-6 sm:p-8 mb-10">
            ...
            <ul className="space-y-3 text-[#1A1A2E] text-sm sm:text-base mb-4">
              ...
              <li className="flex items-start gap-2">
                <span className="text-[#81D9DE] mt-0.5 shrink-0">&#10003;</span>
                <span>
                  The clinical trial numbers side by side (15% &rarr; 21%
                  &rarr; 28.7%)
                </span>
              </li>
              <li className="flex items-start gap-2">
