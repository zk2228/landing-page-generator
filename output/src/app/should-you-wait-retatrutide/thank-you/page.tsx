...
export default function ShouldYouWaitThankYouPage() {
  return (
    <>
      <head>
        ...
        <meta
          name="description"
          content="Download your free guide: Should You Wait for Retatrutide? Full FDA timeline, decision framework, and questions for your provider."
        />
        <meta
          property="og:title"
        ...
        <meta
          ...
          content="Download your free retatrutide decision guide. Evidence-based. Provider-reviewed."
        />
      ...
      <div className="min-h-screen bg-white flex flex-col items-center px-4 py-10 sm:py-16">
        <div className="w-full max-w-2xl flex flex-col items-center">
          ...
          <p className="text-center text-[#666666] text-base sm:text-lg leading-relaxed mb-8 max-w-xl">
            Click below to download your free copy of the retatrutide decision
            guide.
          </p>

          {/* Download Button */}
          <a
            href="/should-you-wait-retatrutide.pdf"
            download
          ...
          <div className="w-full bg-[#F0F9FA] rounded-xl p-6 sm:p-8 mb-10">
            ...
            <ul className="space-y-3 text-[#1A1A2E] text-sm sm:text-base mb-4">
              <li className="flex items-start gap-2">
                ...
                <span>
                  Visual FDA timeline &mdash; where retatrutide actually stands
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#81D9DE] mt-0.5 shrink-0">&#10003;</span>
                <span>
                  The 18-month math: waiting vs. starting treatment now
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#81D9DE] mt-0.5 shrink-0">&#10003;</span>
                <span>
                  Five-scenario decision framework for your situation
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#81D9DE] mt-0.5 shrink-0">&#10003;</span>
                <span>
                  Exact questions to ask your provider at your next visit
                </span>
              </li>
            </ul>
            <p className="text-xs text-[#666666]">
              7 pages &bull; Evidence-based &bull; Provider-reviewed
            </p>
          </div>
